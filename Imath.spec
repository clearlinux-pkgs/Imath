...
Version  : 3.0.3
Release  : 5
URL      : https://github.com/AcademySoftwareFoundation/Imath/archive/v3.0.3/Imath-3.0.3.tar.gz
Source0  : https://github.com/AcademySoftwareFoundation/Imath/archive/v3.0.3/Imath-3.0.3.tar.gz
...
%prep
%setup -q -n Imath-3.0.3
cd %{_builddir}/Imath-3.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622065121
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Imath-3.0.3/LICENSE.md %{buildroot}/usr/share/package-licenses/Imath/ce40fed41edcb2473538bb84f85ff79e585760b5
pushd clr-build-avx512
%make_install_avx512  || :
popd
pushd clr-build-avx2
