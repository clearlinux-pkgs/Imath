...
Version  : 3.1.10
Release  : 26
URL      : https://github.com/AcademySoftwareFoundation/Imath/archive/v3.1.10/Imath-3.1.10.tar.gz
Source0  : https://github.com/AcademySoftwareFoundation/Imath/archive/v3.1.10/Imath-3.1.10.tar.gz
...
%prep
%setup -q -n Imath-3.1.10
cd %{_builddir}/Imath-3.1.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707784680
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Imath-%{version}/website/license.rst %{buildroot}/usr/share/package-licenses/Imath/f24f059045c39a7b9db441ac659e8114810b4ad8 || :
export GOAMD64=v2
GOAMD64=v3
pushd clr-build-avx2
%make_install_v3  || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libImath-3_1.so.29.9.0
/V4/usr/lib64/libImath-3_1.so.29.9.0
/usr/lib64/libImath-3_1.so.29
/usr/lib64/libImath-3_1.so.29.9.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/Imath/ce40fed41edcb2473538bb84f85ff79e585760b5
/usr/share/package-licenses/Imath/f24f059045c39a7b9db441ac659e8114810b4ad8
