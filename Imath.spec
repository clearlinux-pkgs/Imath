...
%prep
%setup -q -n Imath-3.1.11
cd %{_builddir}/Imath-3.1.11
pushd ..
cp -a Imath-3.1.11 buildavx2
popd
pushd ..
cp -a Imath-3.1.11 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720120776
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libImath-3_1.so.29.10.0
/V4/usr/lib64/libImath-3_1.so.29.10.0
